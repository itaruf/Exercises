...
public class Player : MonoBehaviour
{
    ...
    public IEnumerator PlayDeathAnim()
    {
        ...
        dialogue.LinesToDisplay($"You died !");
    ...
    public IEnumerator UseFirstSkill(Enemy enemy)
    {
        ...
        if (skills.Count > 0)
        {
            ...
            enemy.health = Mathf.Clamp(enemy.health, 0, initialHP);
    ...
    public IEnumerator UseThirdSkill(Enemy enemy)
    {
        if (skills.Count > 2)
        {
            ...
            dialogue.LinesToDisplay($"You healed yourself for {skills[2].value} HP !");

            health += skills[2].value;

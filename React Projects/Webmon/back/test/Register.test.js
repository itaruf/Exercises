...
// describe("<Register/>", () => {
//   const wrapper = shallow(<Register />); // la constante wrapper recoit le composant
...
//     it("should be undefined since we haven't clicked to the button ", () => {
...
//       wrapper.find('input[type="mail"]').simulate("change",{target : {value : "mailcorrect@hotmail.com"}})
